...
function blurf(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    ...
    for (let i2 = start, j2 = stop; i2 <= j2; i2 += step) {
      ...
      T2[i2] = (sum3 + t3 * (S2[Math.max(start, i2 - s1)] + S2[Math.min(stop, i2 + s1)])) / w2;
...
function shuffler(random2) {
  return function shuffle2(array2, i0 = 0, i1 = array2.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i2 = random2() * m3-- | 0, t3 = array2[m3 + i0];
...
function arrayMap(array2, iteratee2) {
  var index8 = -1, length = array2 == null ? 0 : array2.length, result2 = Array(length);
  while (++index8 < length) {
    result2[index8] = iteratee2(array2[index8], index8, array2);
  }
  return result2;
}
...
function arrayEach(array2, iteratee2) {
  ...
  while (++index8 < length) {
    if (iteratee2(array2[index8], index8, array2) === false) {
      break;
    }
  }
  return array2;
...
function reorder(array2, indexes2) {
  ...
  while (length--) {
    ...
    array2[length] = isIndex_default(index8, arrLength) ? oldArray[index8] : void 0;
  }
  return array2;
}
...
function replaceHolders(array2, placeholder) {
  var index8 = -1, length = array2.length, resIndex = 0, result2 = [];
  while (++index8 < length) {
    var value = array2[index8];
    if (value === placeholder || value === PLACEHOLDER) {
      array2[index8] = PLACEHOLDER;
...
function overRest(func, start, transform3) {
  ...
  return function() {
    var args = arguments, index8 = -1, length = nativeMax4(args.length - start, 0), array2 = Array(length);
    while (++index8 < length) {
...
function arrayPush(array2, values2) {
  var index8 = -1, length = values2.length, offset = array2.length;
  while (++index8 < length) {
    array2[offset + index8] = values2[index8];
  }
  return array2;
}
...
function baseSlice(array2, start, end) {
  ...
  while (++index8 < length) {
    result2[index8] = array2[index8 + start];
  }
  return result2;
}
...
function arrayReduce(array2, iteratee2, accumulator, initAccum) {
  ...
  while (++index8 < length) {
    accumulator = iteratee2(accumulator, array2[index8], index8, array2);
  }
  return accumulator;
}
...
function chunk(array2, size2, guard) {
  ...
  while (index8 < length) {
    result2[resIndex++] = baseSlice_default(array2, index8, index8 += size2);
  }
  return result2;
}
...
function arrayFilter(array2, predicate) {
  var index8 = -1, length = array2 == null ? 0 : array2.length, resIndex = 0, result2 = [];
  while (++index8 < length) {
    var value = array2[index8];
...
function concat() {
  ...
  var args = Array(length - 1), array2 = arguments[0], index8 = length;
  while (index8--) {
...
function setToArray(set2) {
  var index8 = -1, result2 = Array(set2.size);
...
function baseDifference(array2, values2, iteratee2, comparator) {
  var index8 = -1, includes2 = arrayIncludes_default, isCommon = true, length = array2.length, result2 = [], valuesLength = values2.length;
  if (!length) {
    return result2;
  }
  if (iteratee2) {
  ...
  outer:
    while (++index8 < length) {
      var value = array2[index8], computed = iteratee2 == null ? value : iteratee2(value);
...
function baseWhile(array2, predicate, isDrop, fromRight) {
  var length = array2.length, index8 = fromRight ? length : -1;
  while ((fromRight ? index8-- : ++index8 < length) && predicate(array2[index8], index8, array2)) {
  }
  return isDrop ? baseSlice_default(array2, fromRight ? 0 : index8, fromRight ? index8 + 1 : length) : baseSlice_default(array2, fromRight ? index8 + 1 : 0, fromRight ? length : index8);
}
...
function findIndex(array2, predicate, fromIndex) {
  ...
  return baseFindIndex_default(array2, baseIteratee_default(predicate, 3), index8);
}
...
function findLastIndex(array2, predicate, fromIndex) {
  ...
  return baseFindIndex_default(array2, baseIteratee_default(predicate, 3), index8, true);
}
...
function indexOf(array2, value, fromIndex) {
  ...
  return baseIndexOf_default(array2, value, index8);
}
...
function baseIntersection(arrays, iteratee2, comparator) {
  ...
  outer:
    while (++index8 < length && result2.length < maxLength) {
      var value = array2[index8], computed = iteratee2 ? iteratee2(value) : value;
      value = comparator || value !== 0 ? value : 0;
...
function lastIndexOf(array2, value, fromIndex) {
  ...
  return value === value ? strictLastIndexOf_default(array2, value, index8) : baseFindIndex_default(array2, baseIsNaN_default, index8, true);
}
...
function baseExtremum(array2, iteratee2, comparator) {
  var index8 = -1, length = array2.length;
  while (++index8 < length) {
    var value = array2[index8], current = iteratee2(value);
...
function baseSum(array2, iteratee2) {
  var result2, index8 = -1, length = array2.length;
  while (++index8 < length) {
    var current = iteratee2(array2[index8]);
    if (current !== void 0) {
...
function baseIndexOfWith(array2, value, fromIndex, comparator) {
  var index8 = fromIndex - 1, length = array2.length;
  while (++index8 < length) {
    if (comparator(array2[index8], value)) {
      return index8;
    }
  }
  return -1;
...
function basePullAll(array2, values2, iteratee2, comparator) {
  var indexOf2 = comparator ? baseIndexOfWith_default : baseIndexOf_default, index8 = -1, length = values2.length, seen = array2;
  if (array2 === values2) {
  ...
  while (length--) {
    ...
    if (length == lastIndex || index8 !== previous) {
      ...
      if (isIndex_default(index8)) {
        splice3.call(array2, index8, 1);
      } else {
        baseUnset_default(array2, index8);
      }
    }
  }
  return array2;
...
var pullAt = flatRest_default(function(array2, indexes2) {
  ...
  basePullAt_default(array2, arrayMap_default(indexes2, function(index8) {
...
function baseRange(start, end, step, fromRight) {
  var index8 = -1, length = nativeMax13(nativeCeil4((end - start) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
    result2[fromRight ? length : ++index8] = start;
    start += step;
  }
  return result2;
}
...
function remove(array2, predicate) {
  ...
  var index8 = -1, indexes2 = [], length = array2.length;
...
function shuffleSelf(array2, size2) {
  var index8 = -1, length = array2.length, lastIndex = length - 1;
  size2 = size2 === void 0 ? length : size2;
  while (++index8 < size2) {
    var rand = baseRandom_default(index8, lastIndex), value = array2[rand];
    array2[rand] = array2[index8];
    array2[index8] = value;
  }
  array2.length = size2;
  return array2;
...
function sortedIndexOf(array2, value) {
  var length = array2 == null ? 0 : array2.length;
  if (length) {
    var index8 = baseSortedIndex_default(array2, value);
    if (index8 < length && eq_default(array2[index8], value)) {
      return index8;
    }
  }
  return -1;
...
function sortedLastIndexOf(array2, value) {
  var length = array2 == null ? 0 : array2.length;
  if (length) {
    var index8 = baseSortedIndex_default(array2, value, true) - 1;
    if (eq_default(array2[index8], value)) {
      return index8;
    }
  }
  return -1;
...
function baseUniq(array2, iteratee2, comparator) {
  var index8 = -1, includes2 = arrayIncludes_default, length = array2.length, isCommon = true, result2 = [], seen = result2;
  if (comparator) {
    isCommon = false;
    includes2 = arrayIncludesWith_default;
  } else if (length >= LARGE_ARRAY_SIZE3) {
    var set2 = iteratee2 ? null : createSet_default(array2);
    if (set2) {
...
function unzip(array2) {
  ...
  return baseTimes_default(length, function(index8) {
    return arrayMap_default(array2, baseProperty_default(index8));
  });
}
...
function baseXor(arrays, iteratee2, comparator) {
  ...
  while (++index8 < length) {
    var array2 = arrays[index8], othIndex = -1;
    while (++othIndex < length) {
      if (othIndex != index8) {
        result2[index8] = baseDifference_default(result2[index8] || array2, arrays[othIndex], iteratee2, comparator);
      }
    }
  }
...
function lazyValue() {
  ...
  outer:
    while (length-- && resIndex < takeCount) {
      index8 += dir;
      var iterIndex = -1, value = array2[index8];
...
function P(n2, l2, u2, t3, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, d2, w2, g2, _2, m3 = t3 && t3.__k || v, b = l2.length;
  for (f2 = A(u2, l2, m3, f2, b), a3 = 0; a3 < b; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 != y3.__i && m3[y3.__i] || p, y3.__i = a3, g2 = z(n2, y3, h2, i2, r2, o2, e3, f2, c5, s2), d2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && D(h2.ref, null, y3), s2.push(y3.ref, y3.__c || d2, y3)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y3.__u)) || h2.__k === y3.__k ? f2 = H(y3, f2, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y3.__u &= -7);
  return u2.__e = w2, f2;
}
function A(n2, l2, u2, t3, i2) {
  ...
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = S(e3)), E(e3, e3));
  return t3;
}
...
function z(n2, u2, t3, i2, r2, o2, e3, f2, c5, s2) {
  ...
  else null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = B(t3.__e, u2, t3, i2, r2, o2, e3, c5, s2);
...
function B(u2, t3, i2, r2, o2, e3, f2, c5, s2) {
  ...
  if (null == u2) {
    ...
    u2 = document.createElementNS(o2, x3, k2.is && k2), c5 && (l.__m && l.__m(t3, e3), c5 = false), e3 = null;
  }
  if (null == x3) b === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    else if (v2 && (u2.innerHTML = ""), P("template" == t3.type ? u2.content : u2, d(y3) ? y3 : [y3], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3) for (a3 = e3.length; a3--; ) g(e3[a3]);
...
function J(u2, t3, i2) {
  var r2, o2, e3, f2;
  t3 == document && (t3 = document.documentElement), l.__ && l.__(u2, t3), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t3.__k, e3 = [], f2 = [], z(t3, u2 = (!r2 && i2 || t3).__k = _(k, null, [u2]), o2 || p, p, t3.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t3.firstChild ? n.call(t3.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t3.firstChild, r2, f2), V(e3, u2, f2);
}
function Q(l2, u2, t3) {
...
function link_default(links) {
  var id = index6, strength = defaultStrength, strengths, distance2 = constant_default2(30), distances, nodes, nDim, count2, bias, random2, iterations = 1;
  if (links == null) links = [];
...
var utils = {
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a4 = aligned[0].y, b2 = aligned[1].y, c6 = aligned[2].y, d3 = a4 - 2 * b2 + c6;
      if (d3 !== 0) {
        const m1 = -sqrt(b2 * b2 - a4 * c6), m22 = -a4 + b2, v12 = -(m1 + m22) / d3, v2 = -(-m1 + m22) / d3;
        return [v12, v2].filter(reduce3);
      } else if (b2 !== c6 && d3 === 0) {
        return [(2 * b2 - c6) / (2 * b2 - 2 * c6)].filter(reduce3);
      }
      return [];
    }
    ...
    if (discriminant < 0) {
      ...
      x22 = t12 * cos((phi + tau) / 3) - a3 / 3;
      x3 = t12 * cos((phi + 2 * tau) / 3) - a3 / 3;
...
function ramp(range3) {
  ...
  return function(t3) {
    return range3[Math.max(0, Math.min(n2 - 1, Math.floor(t3 * n2)))];
  };
}
