...
@pytest.mark.asyncio
async def test_calculate_task_roi_contribution():
    ...
    roi_contribution = await calculate_task_roi_contribution(task)
    assert roi_contribution == 23.0

@pytest.mark.asyncio
async def test_update_workflow_roi():
    # Frequency: 1.0 executions per month
